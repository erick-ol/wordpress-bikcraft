...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		<section class="introducao">
			<div class="container">
				<h1 data-anime="400" class="animated fadeInDown"><?php the_field('titulo_introducao'); ?></h1>
				<blockquote data-anime="800" class="animated fadeInDown quote-externo">
					<p><?php the_field('quote_introducao'); ?></p>
					<cite><?php the_field('citacao_introducao'); ?></cite>
				</blockquote>
				<a data-anime="1200" href="/produtos/" class="animated fadeInDown btn">Orçamento</a>
			</div>
		</section>
			...
			<ul class="produtos_lista">
				...
				<li class="grid-1-3">
					...
					<div class="produtos_icone">
						<img src="<?php the_field('imagem_icone'); ?>" alt="Bikcraft <?php the_title(); ?>">
					</div>
					<h3><?php the_title(); ?></h3>
