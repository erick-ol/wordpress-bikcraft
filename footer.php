...
?>		
		...
		<style type="text/css">
			.quebra {
				background: url("<?php the_field('background_footer', $home); ?>") no-repeat center;
		...
		<div class="quebra">
			...
			<?php the_field('frase_footer', $home); ?>
				<cite><?php the_field('autor_footer', $home); ?></cite>
			</blockquote>
		</div>
			...
			<div class="footer">
				<div class="container">
					...
					<div class="grid-8 footer_historia">
						...
						<p><?php the_field('resumo_historia', $home) ?></p>
					</div>
